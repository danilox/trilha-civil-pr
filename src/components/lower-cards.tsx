  ...
  return (
    <section className="lower-grid" aria-label="Informações complementares">
      <Card as="article" id="regioes" className="lower-card lower-card-large" interactive>
        ...
        <Link href="/regioes" className="inline-link ds-focusable">Ver regiões <ArrowRight aria-hidden="true" className="h-3.5 w-3.5" /></Link>
      </Card>
      <Card as="article" id="nota-corte" className="lower-card" interactive>
        ...
        <Link href="/nota-de-corte" className="inline-link ds-focusable">Abrir barreiras <ArrowRight aria-hidden="true" className="h-3.5 w-3.5" /></Link>
      </Card>
      <Card as="article" id="exames" className="lower-card" interactive>
        ...
        <Link href="/exames" className="inline-link ds-focusable">Ver detalhes <ArrowRight aria-hidden="true" className="h-3.5 w-3.5" /></Link>
      </Card>
      <Card as="article" id="dicas" className="lower-card" interactive>
        ...
        <Link href="/dicas" className="inline-link ds-focusable">Abrir dicas <ArrowRight aria-hidden="true" className="h-3.5 w-3.5" /></Link>
      </Card>
      <Card as="article" id="taf" className="lower-card taf-card" interactive><div className="flex items-center justify-between gap-4"><h2>TAF</h2><Activity aria-hidden="true" className="h-5 w-5 text-zinc-500" /></div><p className="mt-4 text-sm leading-6 text-zinc-400">Índices oficiais por sexo biológico e faixa etária. Aprovação exige cumprir todos os exercícios.</p><Link href="/taf" className="inline-link ds-focusable">Ver TAF <ArrowRight aria-hidden="true" className="h-3.5 w-3.5" /></Link></Card>
      <Card as="article" id="titulos" className="lower-card taf-card" interactive><h2>Títulos</h2><p className="mt-4 text-sm leading-6 text-zinc-400">Tabela oficial com limite total de {limiteTotalTitulos.toLocaleString("pt-BR")} pontos. A prova objetiva possui {disciplinasAgente.length} disciplinas.</p><Link href="/titulos" className="inline-link ds-focusable">Ver títulos <ArrowRight aria-hidden="true" className="h-3.5 w-3.5" /></Link></Card>
    </section>
  );
}
