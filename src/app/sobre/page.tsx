...
export const metadata: Metadata = createPageMetadata({
  ...
  description: "Conheça o objetivo, o escopo acadêmico e os limites institucionais do Edital no Controle.",
  path: "/sobre",
});
...
export default function SobrePage() {
  return (
    <InternalPage
      path="/sobre"
      title="Sobre"
      description="Contexto acadêmico, limites institucionais e escopo do MVP Edital no Controle."
      audited
      className="internal-page-lot4 internal-page-prose"
    >
      <InfoCard>
        <h2>Projeto independente e não oficial</h2>
        <p>O Edital no Controle organiza informações de acompanhamento do concurso da Polícia Civil do Paraná, sem vínculo institucional, sem brasão, sem logotipo oficial e sem coleta de dados pessoais.</p>
